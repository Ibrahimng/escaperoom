...
get_header(); ?>
    ...
    <section id="advantage_3d_section" style="background-image:url('<?php echo cs_get_option( 'vendor_video_bg' ); ?>')">
    	<div class="container">
			<div class="row">
				<div class="video_content text-center">
					<a href="#" class="popup_video" data-type="vimeo" data-autoplay="true" href="http://vimeo.com/<?php echo cs_get_option( 'vendor_video_id' ); ?>"><span class="ion-ios-play-outline"></span></a>
					<h2 class="title"><?php echo cs_get_option( 'vendor_title' ); ?></h2>
					<span class="sub-title"><?php echo cs_get_option( 'vendor_video_subtitle' ); ?></span>
				</div>
			</div>
		</div>	
    </section>
